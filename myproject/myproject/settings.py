...
SECRET_KEY = 'django-insecure-*phz0rid)(r32^w--9c7(b=p&l*a@4oi)y5u(t27byeymw!_ny'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True  # Change from False to True for development
...
DATABASES = {
    'default': {
        ...
        'NAME': 'gtracker',        # database name
        'USER': 'myuser',      # database user
        'PASSWORD': 'cosmos',  # user password
